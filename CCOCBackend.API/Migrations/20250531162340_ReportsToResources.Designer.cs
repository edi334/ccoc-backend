...
namespace CCOCBackend.API.Migrations
{
    ...
    [Migration("20250531162340_ReportsToResources")]
    partial class ReportsToResources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.PageImages.PageImageEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.Projects.ProjectEntity", b =>
                {
                    ...
                    b.Property<string>("PresentationImageId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PresentationImageId");
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.Resources.ResourceEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.VolunteeringCarouselPages.VolunteeringCarouselPageEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("VolunteeringId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("VolunteeringCarouselPages", (string)null);
                });

            modelBuilder.Entity("CCOCBackend.API.Stacks.Volunteerings.VolunteeringEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CCOCBackend.Api.Stacks.VolunteeringBenefits.VolunteeringBenefitEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.ToTable("VolunteeringBenefits", (string)null);
                });
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.PageImages.PageImageEntity", b =>
                {
                    ...
                    b.HasOne("CCOCBackend.API.Pages.PageEntity", "Page")
                        .WithMany()
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.Projects.ProjectEntity", b =>
                {
                    b.HasOne("CCOCBackend.API.Stacks.Projects.ProjectEntity", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("MCMS.Files.Models.FileEntity", "PresentationImage")
                        .WithMany()
                        .HasForeignKey("PresentationImageId");

                    b.HasOne("MCMS.Files.Models.FileEntity", "TitleImage")
                        .WithMany()
                        .HasForeignKey("TitleImageId");

                    b.Navigation("Parent");

                    b.Navigation("PresentationImage");
            ...
            modelBuilder.Entity("CCOCBackend.API.Stacks.VolunteeringCarouselPages.VolunteeringCarouselPageEntity", b =>
                {
                    ...
                    b.HasOne("CCOCBackend.API.Stacks.Volunteerings.VolunteeringEntity", "Volunteering")
                        .WithMany()
